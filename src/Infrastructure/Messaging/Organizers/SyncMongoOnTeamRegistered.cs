...
public class SyncMongoOnTeamRegistered : IConsumer<TeamRegisteredEvent>
{
    private readonly IUnitOfWork _sqlUnitOfWork;
    private readonly IUnitOfWork _mongoUnitOfWork;

    public SyncMongoOnTeamRegistered(IServiceProvider serviceProvider)
    {
    ...
    public async Task Consume(ConsumeContext<TeamRegisteredEvent> context)
    {
